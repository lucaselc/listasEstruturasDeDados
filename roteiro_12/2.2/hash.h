...
int insereHash_EnderAberto_lin(Hash* h, int elem){
  if(h == NULL) return 0;
  int i, pos, newPos;
...
int insereHash_EnderAberto_quad(Hash* h, int elem){
  if(h == NULL) return 0;
  int i, pos, newPos;
  pos = chaveDivisao(elem, h->tam);
  for(i=0; i<h->tam; i++){
...
int insereHash_EnderAberto_duplo(Hash* h, int elem){
  if(h == NULL) return 0;
  int i, pos, newPos;
  pos = chaveDivisao(elem, h->tam);
  for(i=0; i<h->tam; i++){
...
int buscaHash_EnderAberto_lin(Hash* h, int elem, int *p){
    if(h == NULL) return 0;
    int i, pos, newPos;
    pos = chaveDivisao(elem, h->tam);
    for(i=0; i<h->tam; i++){
...
int buscaHash_EnderAberto_quad(Hash* h, int elem, int *p){
    if(h == NULL) return 0;
    int i, pos, newPos;
    pos = chaveDivisao(elem, h->tam);
    for(i=0; i<h->tam; i++){
...
int buscaHash_EnderAberto_duplo(Hash* h, int elem, int *p){
    if(h == NULL) return 0;
    int i, pos, newPos;
    pos = chaveDivisao(elem, h->tam);
    for(i=0; i<h->tam; i++){
